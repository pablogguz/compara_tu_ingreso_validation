...
This methodology note presents a simple framework for estimating income distributions in Spain, leveraging granular inequality metrics and administrative data at the census-tract level. Specifically, I model local income distributions assuming log-normality and derive national and regional distributions as population-weighted mixtures of these tract-level estimates. Validation results show a high degree of accuracy, with predicted metrics closely matching observed values across census tracts. Results from a hierarchical variance decomposition exercise show that within-tract variation accounts for the vast majority of income inequality in Spain, and reaffirm the importance of neighborhood-level dynamics in shaping the overall income distribution.

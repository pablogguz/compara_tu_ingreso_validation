...
|-----------|-------------|---------------------|---------|
| `0a. calculate_lognormal.r` | Example of how to calculate log-normal mixture, save `.dta` file for sumnmary stats and validation | ADRH tract data | `data-raw/atlas_all.dta` |
